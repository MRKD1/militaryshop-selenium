...
public class SignUpTest {
	...
	public void signUpTest() {
		...
		driver.findElement(By.id("reg_email")).sendKeys("keceg93866@lovomon.com");
		driver.findElement(By.name("register")).click();
		
		
		assertThat(driver.findElement(By.cssSelector("p > strong:nth-child(1)")).getText(), is("keceg93866"));
